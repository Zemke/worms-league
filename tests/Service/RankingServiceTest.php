            ...
            for ($relSteps = 1; $relSteps <= 10; $relSteps++) {
                ...
                foreach ($files as $file) {
                    ...
                    $season = Helper::setId(
                        ...
                        1);
                    if ($season->getName() === 'NNN38') {
                        // TODO For some reason NNN ranking is missing users that have games played in that season.
                        // Potentially the whole NNN ranking cannot be trusted.
                        // That seems to be the case with season NNN38 only, though.
                        continue;
                    }
                    dump($season->getName());
